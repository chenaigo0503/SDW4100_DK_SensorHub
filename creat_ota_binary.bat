...
python ./tools/scripts/create_cust_image_blob.py --bin ./out/starter_apollo3b_hub.bin --load-address 0xc000 --magic-num 0xcb -o ./out/temp_main_nosecure_ota --version 0x0
